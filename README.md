...
A modern React project built with Vite, TypeScript, Tailwind CSS, and shadcn/ui components.
...
The project includes dark mode support through Tailwind's `dark:` classes and CSS custom properties.
